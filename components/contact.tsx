...
import { ObfuscatedEmailButton, ObfuscatedEmail } from "@/components/obfuscated-email"
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="p-6 bg-card/50 rounded-xl border border-border/50 hover:border-primary/30 transition-all duration-300">
            ...
            <p className="text-sm text-muted-foreground mb-4">View my professional profile and connect on LinkedIn</p>
            <Button
              size="sm"
              variant="outline"
              className="border-primary text-primary hover:bg-primary/10 font-mono"
              asChild
            >
              <a href="https://www.linkedin.com/in/luisalbertmorlas" target="_blank" rel="noopener noreferrer">View Profile</a>
            </Button>
          </div>
          ...
          <div className="p-6 bg-card/50 rounded-xl border border-border/50 hover:border-primary/30 transition-all duration-300">
            ...
            <Button
              ...
              asChild
            >
              <a href="https://koalendar.com/e/meet-with-luis-albert-morla-sanchez" target="_blank" rel="noopener noreferrer">Book Time</a>
            </Button>
          </div>
        </div>
        ...
        <footer className="mt-20 pt-6 border-t border-border/50">
          <div className="flex flex-col items-center space-y-4">
            <div className="flex space-x-6 md:hidden">
              ...
              <a href="https://www.linkedin.com/in/luisalbertmorlas" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="LinkedIn">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
